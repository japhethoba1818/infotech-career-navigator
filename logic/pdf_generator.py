...
def _draw_page2(c, data: dict):
    ...
    for i, uni in enumerate(universities):
        ...
        c.setFillColor(C_LIGHT)
        c.setFont("Helvetica", 7)
        c.drawString(ux + 3*mm, body_y - 9*mm, f"Min APS: {uni['min_aps']}  ·  Check uni website for deadline")
    ...
    checklist = [
        ...
        ("Verify current application dates on each university's official website", False),
